  ...
  return (
    <footer className="px-[5%] pt-14 pb-7" style={{ background: 'var(--dark)', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-12 mb-12">
        <div>
          <div className="f-display font-black text-[1.5rem] tracking-[0.04em] text-white mb-3.5">
          ...
          <a href="https://wa.me/33XXXXXXXXX"
            className="inline-flex items-center gap-2 f-mono text-[0.72rem] px-3.5 py-2 rounded no-underline transition-colors hover:bg-[rgba(37,211,102,0.2)]"
          ...
          <div key={i}>
            ...
            <ul className="list-none flex flex-col gap-2.5">
              {col.links.map(([href, label], j) => (
                <li key={j}>
                  <a href={href} className="text-[0.84rem] no-underline transition-colors hover:text-white/90" style={{ color: 'rgba(255,255,255,0.5)' }}>
                    {label}
                  </a>
                </li>
              ))}
